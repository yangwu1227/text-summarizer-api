...
class TestSummary(object):
    ...
    def test_create_summary_invalid_request(self, test_app, payload, expected_status_code, expected_response) -> None:
        """
    ...
    def test_read_all_summaries(self, test_app_with_db) -> None:
        ...
        assert len(list(filter(lambda summary_schema: summary_schema['id'] == summary_id, response_list))) == 1
